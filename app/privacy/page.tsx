    ...
    <div>
      ...
      <main>
        <div className="container">
          <div className="card">
            <p>
              歡迎使用 Forkcast（以下簡稱「本服務」）。我們非常重視您的隱私與資料安全。本政策說明我們如何蒐集、使用、保護與分享您的個人資料。
            </p>

            <h2>1. 我們蒐集的資料</h2>
            <ul>
              <li>帳戶資料：電子郵件、名稱（若提供）。</li>
              <li>使用資料：您上傳的餐點照片、由 AI 生成的分析結果與紀錄（例如卡路里與營養素）。</li>
              <li>裝置資訊與診斷：應用程式版本、裝置型號、崩潰與錯誤記錄（若啟用）。</li>
            </ul>
            ...
            <ul>
              ...
              <li>OpenAI：影像與文字分析（僅在您請求分析時傳送必要資料）。</li>
              <li>Expo（EAS）：建置與更新發佈（可能收集裝置與版本資訊）。</li>
            </ul>

            <h2>4. 資料保留與刪除</h2>
            <ul>
              <li>您可於應用程式內隨時刪除帳號，相關個人資料將依流程刪除或匿名化。</li>
              <li>法律或合約要求時，我們可能保留必要紀錄於合理期間。</li>
            </ul>

            <h2>5. 資料安全</h2>
            <p>我們採取合理且合適的技術與組織措施保護您的資料，但無法保證 100% 的安全。</p>
            ...
            <h2>9. 政策更新</h2>
            <p>我們可能不時更新本政策。重大更新時，我們會於應用內或網站上提供通知。</p>
